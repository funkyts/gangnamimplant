...
export const CATEGORY_META: Record<string, { name: string; description: string }> = {
    'implant-price': {
        name: '임플란트 가격',
        description: '강남 임플란트 가격과 비용 구조를 브랜드·시술 조건별로 일반적인 시세 범위로 정리한 글 모음입니다. 보험 적용 본인부담금부터 추가 비용까지 한 번에 확인하세요.',
    },
    'implant-procedure': {
        name: '임플란트 시술',
        description: '임플란트 시술 단계, 진료 기간, 임시 치아 등 시술 과정 전반의 정보 글 모음입니다.',
    },
    'implant-care': {
        name: '임플란트 관리',
        description: '시술 후 양치, 식사, 음주, 흡연, 정기검진까지 임플란트를 오래 사용하기 위한 관리 정보입니다.',
    },
    'implant-brands': {
        name: '임플란트 브랜드',
        description: '국산·수입 임플란트 주요 브랜드의 특징과 적용 상황을 정리한 글 모음입니다.',
    },
    'implant-insurance': {
        name: '임플란트 보험',
        description: '65세 이상 건강보험 적용, 본인부담금, 신청 방법 등 임플란트 보험 관련 정보입니다.',
    },
    'dental-crown': {
        name: '치아 크라운',
        description: '지르코니아·올세라믹·PFM 등 크라운 종류별 가격대와 특징을 정리한 정보입니다.',
    },
    'dental-general': {
        name: '일반 치과 정보',
        description: '치아 관리, 치과 진료 일반에 대한 정보 글 모음입니다.',
    },
    'dental-clinic-guide': {
        name: '치과 선택 가이드',
        description: '치과 의료기관 선택 시 참고할 일반적인 기준과 체크리스트를 정리한 정보입니다.',
    },
    'cosmetic-dentistry': {
        name: '심미 치료',
        description: '치아 미백, 라미네이트 등 심미 치료에 대한 정보 글 모음입니다.',
    },
    'orthodontics': {
        name: '치아 교정',
        description: '치아 교정 종류, 기간, 비용 등 교정 치료 전반의 정보입니다.',
    },
};
